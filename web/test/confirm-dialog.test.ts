...
describe('useConfirmDialog', () => {
  ...
  it('retains typed-confirmation options for the dialog host', async () => {
    const p = confirm({
      title: 'Stop orphaned operation?',
      confirmationText: 'thread-123',
      confirmationLabel: 'Type the full thread ID.',
    });
