...
/* Expanded detail: remove the detail subtree while folded. Tool output can be
   very large, so a visually collapsed-but-mounted slot would still impose DOM
   and layout work on the conversation. */
.bb {
  overflow: hidden;
}
.bb-pad {
