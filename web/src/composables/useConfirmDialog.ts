...
// request; ConfirmDialogHost (mounted once in FocusApp.vue) renders it. Callers
...
export type ConfirmOptions = {
  ...
  cancelLabel?: string;
  /**
   * When present, confirmation requires typing this exact value. This only
   * guards against accidental UI activation; it is not an authorization
   * credential and the service still validates the operation itself.
   */
